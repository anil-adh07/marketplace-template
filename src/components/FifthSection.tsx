  ...
  return (
    <div className="fifth-section border-x border-primaryA2">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="first-grid py-6 pl-6 pr-6 md:pr-0 ">
          <img
        ...
        <div className="second-grid my-6 mx-6 md:mr-6 md:mx-0 flex flex-col justify-between bg-primaryA1 break-words">
